const crsTopics = [
    ...
    },
    {
      ...
      objectives: [
        ...
        "ii. identify the rewards for obedience. iii. compare the disobedience of Adam, the people of Israel, Moses, and Saul; iv. indicate the reasons for their disobedience; v. identify the consequences of disobedience."
      ]
    },
    {
      ...
      subtopics: [
        ...
        "(c) David's repentance and forgiveness (II Sam."
      ],
      objectives: [
        "Objectives:",
        "Candidates should be able to:",
    ...
    },
    {
      ...
      {
        title: "Themes from the Four Gospels and the Acts of the Apostles",
        subtopics: [
      ...
      {
        title: "The Triumphal Entry and the Cleansing of the Temple",
        subTopics: [
      ...
      {
        title: "The Trials and the Death of Jesus",
        subTopics: [
      ...
      {
        title: "Resurrection, Appearances, and Ascension of Jesus",
        subTopics: [
