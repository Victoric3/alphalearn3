...
// const message1 = queryCreator(crsTopics[10] , 'hard', courses[0])
// const message2 = queryCreator(crsTopics[11] , 'hard', courses[0])
// const message3 = queryCreator(crsTopics[12] , 'hard', courses[0])
// const message4 = queryCreator(crsTopics[13] , 'hard', courses[0])
// const message5 = queryCreator(crsTopics[14] , 'hard', courses[0])  //enter next req
// const message6 = queryCreator(crsTopics[15] , 'hard', courses[0]) // enter next req
// const message7 = queryCreator(crsTopics[16] , 'hard', courses[0])
// const message8 = queryCreator(crsTopics[17] , 'hard', courses[0])
// const message9 = queryCreator(crsTopics[18] , 'hard', courses[0])
// const message10 = queryCreator(crsTopics[19] , 'hard', courses[0])
